...
class AboutAttributeAccess(Koan):
    ...
    def test_calling_getattribute_causes_an_attribute_error(self):
        ...
        #//really should not do this, but should work
        #//after next test: we can handle AttributeError exceptions
    ...
    def test_changes_to_the_getattribute_implementation_affects_getattr_function(self):
        ...
        self.assertRegex(getattr(catcher, 'any_attribute'), "'any_attribute' and it could not be found")

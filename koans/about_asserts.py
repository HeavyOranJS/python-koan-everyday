...
class AboutAsserts(Koan):
    ...
    def test_assert_truth(self):
        ...
        self.assertTrue(type("i'll try my best") == str) # This should be True

    def test_assert_with_message(self):
        """
        Enlightenment may be more easily achieved with appropriate messages.
        """
        self.assertTrue(type("i thought it'll be about cones") == str, "This should be True -- Please fix this")

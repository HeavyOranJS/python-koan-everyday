...
class AboutRegex(Koan):
    ...
    def test_matching_literal_text_how_many(self):
        ...
        #//Okay, but i changed m quite a lot, is this allowed now?
    ...
    def test_anything_but_matching(self):
        ...
        """
        #added jam and pam, becaus standart variant 
        string = "sales.xlx\n"    \
                + "sales1.xls\n"  \
                + "orders3.xls\n" \
                + "apac1.xls\n" \
        ...
        change_this_search_string = '[^pj]am.xls'
        self.assertEquals(
